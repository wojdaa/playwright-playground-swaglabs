...
test.describe('Product Browsing & Navigation', () => {
    ...
    test('Product Sorting - Name A to Z', async () => {
    ...
    test('Product Sorting - Name Z to A', async () => {
    ...
    test('Product Sorting - Price Low to High', async () => {
    ...
    test('Product Sorting - Price High to Low', async () => {
